...
namespace GUI
{
    public partial class frmUserManagement : Form
    {
        ...
        private void frmUserManagement_Load(object sender, EventArgs e)
        {
            ...
            QuanLyCongViec.GUI.UiHelper.StyleGrid(dataGridView1);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (confirm == DialogResult.Yes)
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("Xóa tài khoản thất bại! Vui lòng kiểm tra lại dữ liệu.", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch (Exception ex)
                {
