...
namespace QuanLyCongViec.DAL
{
    public class ThanhVienDAL
    {
        ...
        public DataTable LayDanhSach()
        {
            ...
            {
                string query = "SELECT MaNV AS MaTV, 'TV' + RIGHT('0000' + CAST(MaNV AS VARCHAR(10)), 4) AS MaTVHienThi, HoTen, SoDienThoai, Email, ViTri AS ChucVu FROM NhanVien";
        ...
        public DataTable TimKiem(string keyword)
        {
            ...
            using (SqlConnection conn = DataConnection.GetSqlConnection())
            {
                string query = "SELECT MaNV AS MaTV, 'TV' + RIGHT('0000' + CAST(MaNV AS VARCHAR(10)), 4) AS MaTVHienThi, HoTen, SoDienThoai, Email, ViTri AS ChucVu " +
